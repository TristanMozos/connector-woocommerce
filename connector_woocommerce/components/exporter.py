...
class WooBaseExporter(AbstractComponent):
    ...
    _name = 'woocommerce.base.exporter'
    _inherit = ['base.exporter', 'base.woocommerce.connector']
    ...
    def _should_import(self):
        ...
        woocommerce_date = datetime.strptime(record['updated_at'],
                                             WOO_DATETIME_FORMAT)
        return sync_date < woocommerce_date
    ...
    def _after_export(self):
        """ Can do several actions after exporting a record on woocommerce """
        pass
...
class WooExporter(AbstractComponent):
    ...
    _name = 'woocommerce.exporter'
    _inherit = 'woocommerce.base.exporter'
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in:
            ...
            constraint "woocommerce_product_product_odoo_uniq"
    ...
    def _export_dependency(self, relation, binding_model,
                           ...
                           binding_field='woocommerce_bind_ids',
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # woocommerce.product.product and we are exporting it,
            # but we need to
            ...
            # If woocommerce_bind_ids does not exist we are typically in a
